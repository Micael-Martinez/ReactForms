...
//             <li>{price}</li>
//             <li>{tag}</li>
//             <li>TypeOf<span style={{color: "green", fontSize: 22, margin: 10}}><strong>{category}</strong></span></li>
//         </ol>
//     )
// }
...
//     const selectValue = document.getElementById("filtering");
//     return(
//         <div>
//             <h1>Filtering Posts:</h1>
//             <h3>Filtrar por:</h3>
...
//                 if(selectValue === "processor") return product.category === "processor"
//                 if(selectValue === "pamera") return product.category === "camera"
//                 if(selectValue === "pamera") return product.category === "microphone"
//             })
